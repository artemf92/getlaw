  ...
  <header class="app-header" :class="!$store.getters.getSidebar ? 'full': ''">
    <div class="app-header-wrapper">
      <div class="left-block">
        ...
        <div class="header-tab" :class="tab === 1 ? 'active' : ''" @click="setTab(1)">Все</div>
        <div class="header-tab" :class="tab === 2 ? 'active' : ''" @click="setTab(2)">На подписании</div>
        <div class="header-tab" :class="tab === 3 ? 'active' : ''" @click="setTab(3)">Подписанные</div>
      </div>
